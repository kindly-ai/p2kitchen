...
from p2kitchen.emojis import EMOJI_MAP
from p2kitchen.slack import emoji_list
from p2kitchen.slack_messages import brew_finished_message, brew_started_message, brew_update_message
...
class SensorEvent(TimeStampedModel):
    ...
    machine = models.ForeignKey("p2kitchen.Machine", on_delete=models.SET_NULL, blank=True, null=True)
...
class SlackProfile(TimeStampedModel):
    ...
    def sync_profile(self, save=True):
        ...
        from p2kitchen.slack import users_profile_get
...
class Brew(TimeStampedModel):
    ...
    machine = models.ForeignKey("p2kitchen.Machine", on_delete=models.CASCADE, related_name="brews")
