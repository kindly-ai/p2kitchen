...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("p2kitchen", "0005_auto_20160607_2325"),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "brew",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="p2kitchen.brew"),
                ),
            ],
            options={
                "get_latest_by": "modified",
        ...
        migrations.AddField(
            model_name="brew",
            name="machine",
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="p2kitchen.machine"),
        ),
        migrations.AddField(
            model_name="brew",
            name="started_event",
