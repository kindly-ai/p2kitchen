...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("p2kitchen", "0006_auto_20210826_1330"),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name="machine",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="brews", to="p2kitchen.machine"
            ),
        ),
        migrations.AlterField(
            model_name="brew",
            name="started_event",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="brews_started", to="p2kitchen.sensorevent"
            ),
        ),
        migrations.AlterField(
            model_name="brewreaction",
            name="brew",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="reactions", to="p2kitchen.brew"
            ),
        ),
        migrations.AlterField(
            model_name="machine",
        ...
        migrations.AddField(
            ...
            name="brewer",
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="p2kitchen.slackprofile"
            ),
        ),
        migrations.AddField(
            model_name="brewreaction",
